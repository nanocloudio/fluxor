...
pub mod dev_system {
    ...
    // ── Live Reconfigure ─────────────────────────────────────────────────
    // Raw primitives consumed by `modules/reconfigure`; the drain /
    // transition-plan / timeout logic lives in that module.
    ...
    pub const RECONFIGURE_MODULE_INFO: u32 = 0x0C6C;
    ...
    /// Returns 0.
    pub const RECONFIGURE_TRIGGER_REBUILD: u32 = 0x0C6D;
    ...
    pub const RECONFIGURE_MODULE_UPSTREAM: u32 = 0x0C6E;
