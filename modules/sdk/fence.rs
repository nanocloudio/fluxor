...
//
// Layer: abi root (public, stable) — a cross-cutting durability/ordering wire
// value-type surfaced by every storage op, kept at `abi::fence` rather than
// under `contracts` (it is a value-type, not a domain contract).
//
